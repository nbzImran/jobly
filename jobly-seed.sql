...
-- Insert technologies
INSERT INTO technologies (name) VALUES ('Python'), ('JavaScript'), ('SQL'), ('React'), ('Node.js');

-- Link jobs to technologies (example: Job ID 1 requires Python & SQL)
INSERT INTO job_technologies (job_id, technology_id)
VALUES 
  (1, 1), -- Job 1 requires Python
  (1, 3), -- Job 1 requires SQL
  (2, 2), -- Job 2 requires JavaScript
  (2, 4), -- Job 2 requires React
  (3, 1), -- Job 3 requires Python
  (3, 5); -- Job 3 requires Node.js

SELECT j.id AS job_id, j.title, t.name AS technology
FROM jobs j
